    ...
    <div className="pt-2">
      ...
      <Card className="mb-6 p-4 sm:p-5">
        ...
        <div className="mt-4 flex justify-end">
          <Button variant="beacon" onClick={onSave} disabled={!canSave}>
          ...
          >
            <Card className="group p-4">
              <div className="flex items-start justify-between gap-3">
                <Pill
                  tone={c.type === "case-study" ? "sage" : "beacon"}
                >
                  {typeLabel(c.type)}
                </Pill>
                <IconButton
              ...
              <h3 className="mt-2.5 font-display text-[17px] leading-snug text-ink">
                {c.title}
              </h3>
